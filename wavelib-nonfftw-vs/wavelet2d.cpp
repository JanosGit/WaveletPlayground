...
double convfft(vector<double> &a, vector<double> &b, vector<double> &cx) {
	...
	kiss_fft_cpx* inp_data = (kiss_fft_cpx*) malloc (sizeof(kiss_fft_cpx) * (sz));
	kiss_fft_cpx* inp_fft = (kiss_fft_cpx*) malloc (sizeof(kiss_fft_cpx) * (sz));
	kiss_fft_cpx* temp_data = (kiss_fft_cpx*) malloc (sizeof(kiss_fft_cpx) * (sz));
	kiss_fft_cpx* filt_data = (kiss_fft_cpx*) malloc (sizeof(kiss_fft_cpx) * (sz));
	kiss_fft_cpx* filt_fft = (kiss_fft_cpx*) malloc (sizeof(kiss_fft_cpx) * (sz));
	kiss_fft_cpx* temp_ifft = (kiss_fft_cpx*) malloc (sizeof(kiss_fft_cpx) * (sz));
